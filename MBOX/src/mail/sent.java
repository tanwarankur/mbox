	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(usrid==null){
			...
			try{
				...
				ResultSet rs=stmt.executeQuery("select * from inbox where sender_id='"+usrid+"'");
				pw.print("<center>");
				
				pw.print("<table border='2' style='width:70%;' bgcolor='lavender'>");
				pw.print("<tr style='background-color:darkslategrey;color:white'><td>Sent To</td><td>Message</td><td>time</td></tr>");
				while(rs.next()){
					pw.print("<tr><td>"+rs.getString("receiver_id")+"</td><td><a href='ViewSent?id="+rs.getString("date")+"'>"+rs.getString("subject")+"</a></td><td>"+rs.getString("date")+"</td></tr>");
				}
				pw.print("</table>");
				pw.print("</center>");
				pw.print("</body>");
